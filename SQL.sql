...
create table Movie (
    ...
    movieMinutes varchar(5) NOT NULL,
...
INSERT INTO Movie (movieID, title, movieMinutes, movieDuration, theaterID, movieDescription)
VALUES (001, 'The Shawshank Redemption', '10AM', 142, 001, 'Framed in the 1940s for the double murder of his wife and her lover, 
        ...
        (003, 'The Godfather: Part 2', '12PM', 200, 'The continuing saga of the Corleone crime family tells the story of a young Vito Corleone 
        ...
        (004, 'The Dark Knight', '1PM', 152, 'Batman raises the stakes in his war on crime. With the help of Lt. Jim Gordon and District Attorney 
        ...
        (005, 'Schindlers List', '2PM', 195, 'Told from the perspective of businessman Oskar Schindler who saved over a thousand Jewish lives from the 
        ...
        (006, '12 Angry Men', '3PM', 96, '12 Angry Men is the 1957 film debut for director Sidney Lumet. An interpretion from a Broadway show, this film 
        is about 12 jurors who must decide whether an 18-year-old is guilty of killing his father.'),
        
        (007, 'Pulp Fiction', '4PM', 148, 'Pulp Fiction is a cult film by Director Quentin Tarantino with three interwoven plots with lots of violence, 
        absurdity, and great music. The film is Tarantinos most famous and the film that cemented his name and style in Hollywood.'),
        
        (008, 'LOTR: Return of the King', '5PM', 201, 'Aragorn is revealed as the heir to the ancient kings as he, Gandalf and the other members of the 
        ...
        (009, 'The Good, the Bad and the Ugly', '6PM', 161, 'A bounty hunting scam joins two men in an uneasy alliance against a third in a race to find 
        ...
        (010, 'Fight Club', '7PM', 148, 'A ticking-time-bomb insomniac and a slippery soap salesman channel primal male aggression into a shocking new 
        ...
        (011, 'LOTR: The Fellowship of the Ring', '8PM', 200, 'Young hobbit Frodo Baggins, after inheriting a mysterious ring from his uncle Bilbo, must 
        ...
        (012, 'Star Wars: Episode V', '9PM', 130, 'The epic saga continues as Luke Skywalker, in hopes of defeating the evil Galactic Empire, learns the ways 
        ...
        (013, 'Forrest Gump', '10PM', 142, 'A man with a low IQ has accomplished great things in his life and been present during significant historic events - 
        ...
        (014, 'Inception', '11PM', 148, 'Cobb, a skilled thief who commits corporate espionage by infiltrating the subconscious of his targets is offered a chance 
